...
$query1 = "SELECT * FROM agzalar where derejesi='talyp' and fakulteti='kompýuter ylymlary we maglumat tehnologiýalary' and baly !=0 and berlen_derejesi != 3 ORDER BY baly DESC LIMIT 0,10";//4 sany taltby saylaya
$result1 = mysqli_query($connect,$query1);

$query2 = "SELECT * FROM agzalar where derejesi='talyp' and fakulteti='kompýuter ylymlary we maglumat tehnologiýalary' and berlen_derejesi=3";
