...
$query1 = "SELECT * FROM agzalar where derejesi='talyp' and fakulteti='himiki we nanotehnologiýalar' and baly !=0 and berlen_derejesi != 3 ORDER BY baly DESC LIMIT 0,4";
$result1 = mysqli_query($connect,$query1);

$query2 = "SELECT * FROM agzalar where derejesi='talyp' and fakulteti='himiki we nanotehnologiýalar' and berlen_derejesi=3";
