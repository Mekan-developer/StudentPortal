...
$query1 = "SELECT * FROM agzalar where derejesi='talyp' and fakulteti='biotehnologiýalar we ekologiýa' and baly !=0 and berlen_derejesi != 3 ORDER BY baly DESC LIMIT 0,4";
$result1 = mysqli_query($connect,$query1);

$query2 = "SELECT * FROM agzalar where derejesi='talyp' and fakulteti='biotehnologiýalar we ekologiýa' and berlen_derejesi=3";
