...
function BildirishSearch($var){
	...
	while($row = mysqli_fetch_assoc($result)){
		...
		$post_like_count = $row['post_view_count'];
	...
	?>
	  <tr>
		...
		<?php 
           ...
           $surat = $row['suraty']; 
	    ?>
	    <td><a target="_blank" href="../../register/img/<?php echo $surat ;?>"><img class="agzalar_imgg" alt="surat ýok!" src="../../register/img/<?php echo $surat; ?>"></a></td>



		<td class="back"><a onClick="javascript: return confirm('Siz hakykatdanam <?php echo $post_name." - bildirişini"; ?>  udalit etmekçimi!');" class="delete" href="index.php?page=bildirisler&update=delete&id=<?php echo $id;?>">delete</a></td>
	 </tr>
