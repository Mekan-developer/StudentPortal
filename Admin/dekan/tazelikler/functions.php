...
function TazelikSearch($var){
	...
	<td class="back"><a onClick="javascript: return confirm('Siz hakykatdanam <?php echo $news_name." - täzeligini"; ?>  udalit etmekçimi!');" class="delete" href="index.php?page=tazelikler&update=delete&id=<?php echo $id;?>">Delete</a></td>
	</tr>
