...
<?php 
    ...
    if(isset($_POST['submit']) && $_POST['search']!=''){
        $name = $_POST['search'];
        $query = "SELECT * FROM vocabulary where degisli_fakulteti = '$user_fakulteti' and tassyklananmy != 'howwa' and english  LIKE '$name%'";
        ...
        ?>
                ...
                ?>
                 ...
                 <td class="back"><a onClick="javascript: return confirm('Siz hakykatdanam bu sözi udalit etmekçimi!');" class="delete" href="index.php?page=sozluk&id=<?php echo $id;?>">delete</a></td>
...
$query = "SELECT * FROM vocabulary where degisli_fakulteti = '$user_fakulteti' and tassyklananmy != 'howwa' order by id desc";
$result = mysqli_query($connect,$query);
$id_count=0;
while($row = mysqli_fetch_assoc($result)){
    $id = $row['id']; $id_count++;  
...
?>
        ...
        ?>
         ...
         <td class="back"><a class="delete" onClick="javascript: return confirm('Siz hakykatdanam bu sözi udalit etmekçimi!');"  href="index.php?page=sozluk&id=<?php echo $id;?>">delete</a></td>
