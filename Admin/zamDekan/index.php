...
if($userSany>0 or $logged == 'loged_in'){
    ...
    if($derejesi != 2 && $Talyp_Mugall != 'mugallym'){header("Location:../../login/");}
    $user_id = $row['id'];
...
<style>    
	...
	<div class="mainContainer">
		<div class="navigation">
			<center><a href="index.php"><img class="ZamAdmin" src="icons/zam.png"></a></center>
			<div>
            ...
            <div>
	            <label for="nav3"><img class="teach size" src="icons/navBar.png">Bildirişler</label>
	            <input id="nav3" type="checkbox">
	                <div class="hidden3 hidden">
	                    <a href="index.php?page=bildirishler">Bildirişler</a><br>
	                    <a href="index.php?page=bildirish_gosh">Bildiriş goş</a><br>
	                 <!--    <a href="index.php?page=mugallymlar">Goşanlarym</a><br> -->
	                </div>
            </div>
           
            <div>
	            <label for="nav4"><img class="teach size" src="icons/navBar.png">Täzelikler</label>
	            <input id="nav4" type="checkbox">
	                <div class="hidden4 hidden">
	                    <a href="index.php?page=tazelikler">Täzelikler</a><br>
